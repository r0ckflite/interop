...
rails new interop4 -m https://raw.github.com/RailsApps/rails-composer/master/composer.rb

rails generate migration addWMSTables

Edit above, and cut and paste

--------------------

class AddWmsTables < ActiveRecord::Migration
 def self.up
